    ...
    <main className="min-h-screen flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 sm:px-16 lg:px-24">
        <div className="w-full max-w-[400px] mx-auto">
          ...
          <h2 className="text-2xl font-bold text-x-black mt-10 mb-6">Iniciá sesión</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <input
              ...
              required
              className="border border-[#cfd9de] rounded-md px-3 py-3.5 text-[15px] focus:outline-none focus:border-x-blue focus:ring-1 focus:ring-x-blue transition"
            />
            <input
              id="password"
              type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-x-black hover:bg-black/85 disabled:opacity-50 text-white font-bold rounded-full py-3.5 text-[15px] transition-colors"
            >
